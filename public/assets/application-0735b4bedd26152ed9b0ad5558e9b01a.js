...
(function() { this.JST || (this.JST = {}); this.JST["boards/board_show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h3>',  board.escape('title') ,'</h3>\n<a href="#">Back to Index</a>\n\n<div class="lists-list row sortable"></div>\n<div class="new-list"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["boards/boards_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h4>make a new board</h4>\n<form class="board-form">\n  <label>Title:\n    <input type="text" name="board[title]">\n  </label>\n  <input type="submit" value="create board">\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["boards/boards_index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h3>Your Boards</h3>\n<div class="boards-list row"></div>\n\n<div class="form-area"></div>\n<button class="new-board">New Board</button>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["boards/boards_index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="board group">\n  <a href="#/boards/',  board.id ,'">\n    <h4>',  board.escape('title') ,'</h4>\n  </a>\n  <br>\n  <button class="delete">Delete Board</button>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["cards/card_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form class="card-form">\n  <h4>Make a New Card</h4>\n  <label>Title:\n    <input type="title" name="card[title]">\n  </label>\n  <label>Description:\n    <input type="text" name="card[description]">\n  </label>\n  <button type="submit">create card</button>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["cards/card_show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="card">\n  <h5>',  card.escape('title') ,'</h5>\n  (',  card.escape('description') ,')\n  <button class="delete-card">Delete</button>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["lists/list_show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="list-content">\n  <h4>',  list.escape('title') ,'</h4>\n  <div class="cards sortable">\n  </div>\n  <button class="delete-list">Delete List</button>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["lists/lists_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h5>make a new list</h5>\n<form class="list-form">\n  <label>Title:\n    <input type="title" name="list[title]" value="">\n  </label>\n  <input type="submit" value="create list">\n</form>\n');}return __p.join('');};
}).call(this);
